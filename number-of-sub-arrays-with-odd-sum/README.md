<h2>1524. Number of Sub-arrays With Odd Sum</h2><h3>Medium</h3><hr><div><p>Given an array of integers <code>arr</code>, return <em>the number of subarrays with an <strong>odd</strong> sum</em>.</p>
